    ...
    relationships: [
      ...
      },
      {
        ...
        notes: [
          ...
          note(
            "Change history",
            "1. **2026-02-14** — VPN tunnel established, VLAN 12 assigned\n2. **2026-04-03** — Direction widened from one-way to two-way to support multi-tenant lookups\n\n> Any further direction changes need sign-off from both space owners.",
          ),
        ],
      },
    ],
